...
const research: ResearchItem[] = [
  ...
  { status: "archived", badge: "Archived", title: "Picasso: A Multi-Label Emotion-to-Art Framework", venue: "Using SBERT, VAD features, and diffusion models", year: "—",
    body: "Abstract—Art and emotion are deeply intertwined, yet most AI systems reduce emotion to a superficial label. Picasso reimagines this relationship through a unified pipeline that preserves affective nuance across text, vision, and language. It begins with a multi-label Sentence-BERT (SBERT) classifier augmented with interpretable Valence–Arousal–Dominance (VAD) features, capturing fine-grained emotional cues. These cues inform structured prompts for Stable Diffusion XL, guiding the generation of abstract, emotion-driven artwork, while a large language model (LLM) generates concise, emotionally aligned narratives based on the visuals and affective context. To support this pipeline, we harmonize three emotion-rich corpora—DailyDialog, EmpatheticDialogues, and GoEmotions—into a challenging 45-label dataset that preserves both common and rare emotions. This foundation enables Picasso to express subtle emotional blends that are often missed by conventional approaches.", link: "https://drive.google.com/file/d/1iAJuH6f21keznF0YTyLzMTmY0tBVuEuf/view?usp=drive_link" },
];
