...
## Quick Reference: Colab GPU Tiers

Before you plan a training run, know what silicon you're gambling for:

| GPU | VRAM | Tier | Best For |
| --- | --- | --- | --- |
| T4 | 16 GB | Free | Inference, LoRA fine-tunes, small CNNs |
| L4 | 24 GB | Pro | Medium training runs, SDXL inference |
| A100 | 40 GB | Pro+ | Serious fine-tuning, LLM experiments |
| V100 | 16 GB | Legacy Pro | Faster than T4, increasingly rare |
| TPU v2-8 | 64 GB HBM | Free-ish | JAX / TensorFlow workloads |

> Rule of thumb: if the session hands you an A100, **checkpoint twice as often** — the universe will try to take it back.
